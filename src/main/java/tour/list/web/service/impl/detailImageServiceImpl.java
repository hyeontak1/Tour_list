...
import tour.list.web.model.detailImage;
...
public class detailImageServiceImpl implements detailImageService{
	...
	public detailImageServiceImpl(SqlSession sqlSession) {
	...
	public detailImage getDetailImageItem(detailImage input) throws Exception {
		detailImage result = null;
		try {
			result = sqlSession.selectOne("detailImageMapper.selectItem", input);
			if(result == null) {
	...
	public List<detailImage> getDetailImageList(detailImage input) throws Exception {
		List<detailImage> result = null;
		try {
			result = sqlSession.selectList("detailImageMapper.selectList", input);
			if(result == null) {
				throw new NullPointerException("result=null");
			}
		} catch(NullPointerException e) {
	...
	public int getDetailImageCount(detailImage input) throws Exception {
		int result = 0;
		try {
			result = sqlSession.selectOne("detailImageMapper.selectCount", input);
		} catch (Exception e) {
			log.error(e.getLocalizedMessage());
			throw new Exception("데이터 조회에 실패했습니다.");
		}
	...
	public int addDetailImage(detailImage input) throws Exception {
		int result = 0;
		try {
			result = sqlSession.insert("detailImageMapper.insertItem", input);
			if(result == 0) {
	...
	public int editDetailImage(detailImage input) throws Exception {
		int result = 0;
		try {
			result = sqlSession.update("detailImageMapper.updateItem", input);
			if(result == 0) {
				throw new NullPointerException("result=0");
			}
		} catch(NullPointerException e) {
	...
	public int DeletedetailImage(detailImage input) throws Exception {
		int result = 0;
		try {
			result = sqlSession.delete("detailImageMapper.deleteItem", input);
			if (result == 0) {
				throw new NullPointerException("result=0");
			}
		} catch(NullPointerException e) {
